...
function sendMessageH($chat_id, $text) {
    $token = 'PUT YOUR BOT TOKEN'; // Replace with your bot token
...
$bot_token = $token;
$botToken = 'PUT YOUR BOT TOKEN';
$admin = "PUT YOUR USER ID";
$xnx = true;
$stop = false;
$admin2 = "PUT YOUR USER ID";
...
$txt = "<b>@$username You Are Already a Bot User</b>";
 ...
 // Create the keyboard markup
     ...
     if($text == "Contact"){
         sendMessage($chat_id , "FOR HELP DM @PORTAL_LUIS");
     }
...
CONTACT  @PORTAL_LUIS TO ADD FUNDS MANUALLY</b>");
      }
      }
...
FAMPAY USERS PAY AND SEND SCREEN SHOT IN DM @PORTAL_LUIS</i></b>");
}
